...
const experiencesData = [
	{
		...
		logo: kraneLogo,
		details: [
			'Lead creation of enterprise level web application using TypeScript, React and Redux.',
			'Ensured AA and AAA accessibility guidelines followed.',
			'Collaborated with other engineers and product owners to gather product guidelines.',
			'Implemented new RESTful API endpoints utilizing Nest.js.',
		],
		icons: [
			<TypeScriptIcon />,
			<ReactIcon />,
	...
	},
	{
		...
		details: [
			...
			'Ensured data integrity of mySQL databases.',
